...
void WithDrawMoneyFromAccount() {
    ...
    do {
        ...
        /*cout << "8 - Вывод в USD" << endl;
        cout << "9 - Вывод в EUR" << endl;*/
        cout << " Выберите вариант вывода средств (1-9) " << endl;
        ...
        default:
            ...
            break;
       /* case 8:
            cout << " Вывод в USD : " << endl;
            cin >> CustomerRequest;
            valueToWithdraw = 2.3700;
            valueToWithdraw = CustomerRequest;
            isNotFinished = false;
            break;
        case 9:
            cout << " Вывод в EUR : " << endl;
            cin >> CustomerRequest;
            valueToWithdraw = 2.3700;
            valueToWithdraw = CustomerRequest;
            isNotFinished = false;
